...
class RowScreen110 extends StatelessWidget {
  const RowScreen110({super.key});
        ...
        child: Container(
            ...
            child: Row(
              children: [
                // Expanded
                //   - 남아 있는 공간을 모두 찾이 한다.
                //   - 여러게 존재 시 서로 균등 분할 한다.
                //   - flex : 남은 공간을 찾이할 비율
                Expanded(
                  flex: 2,
                  child:
                      Container(color: Colors.red, width: 30.0, height: 50.0),
                ),
                // Expanded(
                Container(color: Colors.orange, width: 30.0, height: 50.0),
                //),
                Expanded(
                  child: Container(
                      color: Colors.yellow, width: 30.0, height: 50.0),
                ),
                Expanded(
                  child:
                      Container(color: Colors.grey, width: 30.0, height: 50.0),
                ),
              ],
            )),
      ),
