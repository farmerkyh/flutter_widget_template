...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: HeatmapCalendar110(),
    );
  }
}

class HeatmapCalendar110 extends StatefulWidget {
  const HeatmapCalendar110({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _HeatmapCalendar110();
}

class _HeatmapCalendar110 extends State<HeatmapCalendar110> {
