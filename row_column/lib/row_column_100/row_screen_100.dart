...
class RowScreen100 extends StatelessWidget {
  const RowScreen100({super.key});
        ...
        child: Container(
            ...
            child: Row(
              ...
              children: [
                ...
                Expanded(
                  child: Container(
                      color: Colors.orange, width: 50.0, height: 50.0),
                ),
                Expanded(
                  child: Container(
                      color: Colors.yellow, width: 50.0, height: 50.0),
                ),
                Expanded(
                  child:
