...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: HeatMapCalendar500(),
      theme: ThemeData(primarySwatch: Colors.green),
    );
  }
}

class HeatMapCalendar500 extends StatefulWidget {
  const HeatMapCalendar500({super.key});

  @override
  State<HeatMapCalendar500> createState() => _HeatMapCalendar500State();
}

class _HeatMapCalendar500State extends State<HeatMapCalendar500> {
