...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: HeatmapCalendar100(),
    );
  }
}

class HeatmapCalendar100 extends StatefulWidget {
  const HeatmapCalendar100({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _HeatmapCalendar100();
}

class _HeatmapCalendar100 extends State<HeatmapCalendar100> {
